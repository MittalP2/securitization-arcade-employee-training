...
const tourSteps:TourStep[] = [
  ...
  { target:'[data-tour="feedback"]', eyebrow:'LEARNING COACH', title:'Turn reflection into a personalized next move', text:'Share clarity and confidence after a completed day. The Learning Coach reads the evidence, retrieves approved context, chooses a next action, and remembers what to review.' },
...
export default function Home(){
  ...
  async function generateCoachDebrief(feedback:DayFeedback){
    ...
    setNotice(result.mode==='agent'?`Day ${selectedDay} Learning Coach debrief ready.`:`Day ${selectedDay} debrief ready in safe fallback mode.`);
    return result;
  }
  function resetDay(){
