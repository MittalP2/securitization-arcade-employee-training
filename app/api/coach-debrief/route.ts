...
const tools:ToolDefinition[]=[
  ...
  {type:'function',function:{name:'update_review_queue',description:'Add only fragile or repeatedly missed concepts to cross-session review memory.',parameters:{type:'object',properties:{concepts:{type:'array',items:{type:'string'},maxItems:3},memory_note:{type:'string'}},required:['concepts','memory_note']}}},
