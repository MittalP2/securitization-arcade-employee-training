...
| **What should it never do?** | It must never invent financial facts, silently change the syllabus, expose another learner’s information, or present educational content as deal-specific legal, investment, accounting, or rating advice. |
| **Human-in-the-loop** | The learner controls progression, can reject recommendations, and reviews answers before marking a lesson complete. A qualified human must handle questions requiring deal-specific judgment, current market interpretation, or professional advice. |
| **What happens when something breaks?** | It retries a failed lookup once, then falls back to the static approved lesson and clearly reports what is unavailable. If reliable course material cannot answer the question, it stops and asks the learner for clarification or recommends human review. |
| **How do you know it worked?** | A learner can complete a daily mission and accurately explain or apply its main concept in under 20 minutes, with at least an 80% quiz and application success rate. |

## Learning journey

- Days 1–30 form the core learning journey.
- Day 30 is the final exam and graduation milestone.
- Days 31–32 are advanced bonus levels covering funding, pool management, and encumbrance controls.

## Current status

The first product draft establishes the three-pane learning workspace, Day 1 experience, course navigation, knowledge-map direction, and entry points for flashcards and quizzes. The remaining lessons and interactive tools will be developed incrementally from the existing 32-day curriculum.
